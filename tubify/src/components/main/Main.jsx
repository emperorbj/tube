        ...
        <div className='flex-1 min-h-[100vh] pb-[15vh] relative dark:bg-slate-950'>
            ...
            <div className=' max-w-[900px] m-auto'>
                ...
                <div className='absolute  mt-[80px] bottom-0 w-[100%]  max-w-[900px] py-0 px-[20px] m-auto'>
                    {/* search bar */}
                    <div className=' flex items-center justify-between gap-2 lg:gap-[20px] bg-slate-100 py-[20px] px-[10px] lg:py-[40px] lg:px-[30px] rounded-[20px]'>
                        <input onChange={(e) => setInput(e.target.value)} value={input} className=' outline-none border-none bg-slate-100 w-[200px] sm:w-[300px] lg:w-[600px] text-[20px]' type="text" placeholder='Enter a prompt here' />
                        <div>
                            <img className='bg-purple-500 cursor-pointer' onClick={() => onSend()} width={30} src={assets.send_icon} alt="" />
                        </div>
                    </div>
